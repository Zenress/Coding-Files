...
namespace Database_and_WPF.Entities {
    ...
    public partial class MovieDatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class MoviesDataTable : global::System.Data.TypedTableBase<MoviesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public MoviesRow AddMoviesRow(string MovieName, int ReleaseYear, string Genre, string Instructor, string Actors) {
            ...
            private void InitClass() {
                ...
                this.columnActors.MaxLength = 500;
            }
        ...
        public partial class MoviesRow : global::System.Data.DataRow {
            ...
            public string Instructor {
                get {
                    return ((string)(this[this.tableMovies.InstructorColumn]));
                }
                set {
                    this[this.tableMovies.InstructorColumn] = value;
                }
            }
...
namespace Database_and_WPF.Entities.MovieDatabaseDataSetTableAdapters {
    ...
    public partial class MoviesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Movies] WHERE (([Id] = @Original_Id) AND ([MovieName] = @Origi" +
                "nal_MovieName) AND ([ReleaseYear] = @Original_ReleaseYear) AND ([Genre] = @Origi" +
                "nal_Genre) AND ([Instructor] = @Original_Instructor) AND ([Actors] = @Original_A" +
                "ctors))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Movies] ([MovieName], [ReleaseYear], [Genre], [Instructor], [Actors]) VALUES (@MovieName, @ReleaseYear, @Genre, @Instructor, @Actors);
SELECT Id, MovieName, ReleaseYear, Genre, Instructor, Actors FROM Movies WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Movies] SET [MovieName] = @MovieName, [ReleaseYear] = @ReleaseYear, [Genre] = @Genre, [Instructor] = @Instructor, [Actors] = @Actors WHERE (([Id] = @Original_Id) AND ([MovieName] = @Original_MovieName) AND ([ReleaseYear] = @Original_ReleaseYear) AND ([Genre] = @Original_Genre) AND ([Instructor] = @Original_Instructor) AND ([Actors] = @Original_Actors));
SELECT Id, MovieName, ReleaseYear, Genre, Instructor, Actors FROM Movies WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Database_and_WPF.Properties.Settings.Default.MovieDatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, MovieName, ReleaseYear, Genre, Instructor, Actors FROM dbo.Movies";
        ...
        public virtual int Delete(int Original_Id, string Original_MovieName, int Original_ReleaseYear, string Original_Genre, string Original_Instructor, string Original_Actors) {
            ...
            if ((Original_Actors == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[5].Value = ((string)(Original_Actors));
            }
        ...
        public virtual int Insert(string MovieName, int ReleaseYear, string Genre, string Instructor, string Actors) {
            if ((MovieName == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[1].Value = ((int)(ReleaseYear));
            if ((Genre == null)) {
        ...
        public virtual int Update(string MovieName, int ReleaseYear, string Genre, string Instructor, string Actors, int Original_Id, string Original_MovieName, int Original_ReleaseYear, string Original_Genre, string Original_Instructor, string Original_Actors, int Id) {
            if ((MovieName == null)) {
                throw new global::System.ArgumentNullException("MovieName");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(ReleaseYear));
            if ((Genre == null)) {
                throw new global::System.ArgumentNullException("Genre");
            }
            else {
            ...
            if ((Original_Actors == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((string)(Original_Actors));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string MovieName, int ReleaseYear, string Genre, string Instructor, string Actors, int Original_Id, string Original_MovieName, int Original_ReleaseYear, string Original_Genre, string Original_Instructor, string Original_Actors) {
            return this.Update(MovieName, ReleaseYear, Genre, Instructor, Actors, Original_Id, Original_MovieName, Original_ReleaseYear, Original_Genre, Original_Instructor, Original_Actors, Original_Id);
        }
    }
